...
OpenCV requires us to label positive and negative samples through a text file. So for negative samples, we would create a `bg.txt` and for positive samples we would create `info.lst`.
...
![dir_list](../images/cascade_dir_list.JPG)
